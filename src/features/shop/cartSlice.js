...
export const cartSlice = createSlice({
    ...
    reducers: {
        ...
        clearOneItemFromCart: (state, action) => {
            const newItem = action.payload
            const selectCartIndex = state.items.findIndex(product => product.id === newItem.id)
...
export const { addItemToCart, removeItemFromCart, clearOneItemFromCart, clearItemsFromCart, addItemWithQuantity } = cartSlice.actions
